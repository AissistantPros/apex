...
def build_system_prompt(profile: dict) -> str:
    ...
    lines += [
        ...
        "- Esta conversación NO tiene memoria persistente entre sesiones. Se borra al cerrar la sesión.",
        "- BIBLIOTECA: el médico cargó sus propios libros y guías al sistema. Cuando tu contexto incluya un bloque de 'BIBLIOTECA CLÍNICA DEL MÉDICO', esos fragmentos SÍ son de sus libros — úsalos para fundamentar tu respuesta y cítalos por título y autor. NUNCA digas que no tienes acceso a sus documentos si ese bloque está presente. Si no aparece ningún fragmento relevante, es que la biblioteca no tenía nada sobre el tema; entonces respóndelo con tu conocimiento o con búsqueda web.",
